...
//			Nhập hai xâu kí tự s1, s2 nối xâu kí tự s2 vào sau xâu s1;
		...
		System.out.println("Su dung concat: " + s3);
		scanner.close();
...
//			viết hoa chữ cái đầu thì viết hoa lên
		...
		String leftCharacter = ten.substring(1); //substring lay chuoi tu vi tri x den het
...
//			chuẩn hóa thành "Nguyễn Văn Nam"
		...
		for (int i = 0; i < words.length; i++) {
			...
			String leftCharacter = words[i].substring(1).toLowerCase();
...
//		System.out.println("after replace " + str);
		...
		String[] words = str.split(" ");// tach tu theo dau cach cho vao array
